shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    tabsetPanel(
      ...
      tabPanel(
        "Help",
        p("Instructions: Enter your child's gender, age, and measurements.  For each measurement, select the proper units.  Then hit submit to learn what percentile they are in for each measurement - weight, height and head circumference.  Gender and Age are required, but if you do not know all of the measurements you can simply enter the ones that you do know.")
        )
      )
    ),
  mainPanel(
